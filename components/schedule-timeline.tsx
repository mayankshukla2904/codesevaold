...
return (
  <section className="py-20 bg-gradient-to-b from-black to-background text-white min-h-screen">
                ...
                {events.map((event, index) => (
                  ...
                  >
                    <div className={cn(
                      ...
                      <div className="bg-cyan-900/80 backdrop-blur-sm p-4 rounded-lg max-w-sm w-full hover:bg-cyan-800/90 transition-colors">
